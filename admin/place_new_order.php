    ...
    // Fetch all clients
    $clients = [];
    $result = $connect->query("SELECT client_id, vendor_name FROM clients");
                    ...
                    <form method="POST" id="order_form">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <label class="col-12 col-md-2 text-md-start text-lg-end col-form-label"><strong>Total COD
                                    Amount</strong></label>
                            <div class="col-12 col-md-4">
                                <input type="text" id="total_cod" name="total_cod" class="form-control" value="0"
                                    readonly>
                            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $query = "INSERT INTO orders (
            ...
            '$customer_phone', '$customer_address', '$customer_address', '$customer_address', '$city', '$order_date', '$status', '$total_cod','1'
        )";
